...
public interface KieUtilFactoryService {

	List<ProcessServicesClient> getProcessClientList();

	List<UserTaskServicesClient> getUserTaskClientList();

	List<KieServicesClient> getKieClientList();
